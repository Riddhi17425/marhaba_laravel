            ...
            <div class="pd_left">
                ...
                <div>
                    <section class="age_range_section">
                        <div class="age_range_box d-flex justify-content-center align-items-center" style="background-color: rgb(239, 230, 240);cursor: default;">
                            <div class="age-card">
                                <p class="raleway_14 mb-0">MOQ</p>
                                <h3 class="fs_18 mb-0">12 units per design</h3>
                            </div>
                        </div>
                        <div class="age_range_box d-flex justify-content-center align-items-center" style="background-color: rgb(243, 242, 231);cursor: default;">
                            <div class="age-card">
                        ...
                        <div class="age_range_box d-flex justify-content-center align-items-center" style="background-color: rgb(230, 239, 242);cursor: default;">
                            <div class="age-card">
            ...
            <div class="pd_right">
                <div>
                    @php
                        ...
                        $whatsappUrl = "https://api.whatsapp.com/send?phone=971502283252&text=" . urlencode($message);
                    @endphp
                ...
                <div>
                    <div class="pd_social">
                        ...
                        <span><a href="">WhatsApp Catalogue: +971 50 228 3252</a></span>
