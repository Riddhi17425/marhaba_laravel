...
<link rel="stylesheet" href="{{ asset('public/front/css/hero_responsive.css') }}">
        ...
        <div class="yellow-gradient">
            <div class="ym-container">
                <div class="home_brand_bg">
                    ...
                    <img loading="lazy" src="{{ asset('public/brand_images/' . $value->image) }}" alt="{{ $value->name }}" class="img-fluid">
                    <!--<img loading="lazy" src="https://marhabafashion.com/public/brand_images/baby_starters.png" alt="">-->
                    <!--<img loading="lazy" src="https://marhabafashion.com/public/brand_images/my_melody.png" alt="">-->
                    <!--<img loading="lazy" src="https://marhabafashion.com/public/brand_images/smart_kids.png" alt="">-->
                    @endforeach
                </div>
            </div>
        </div>
            ...
            <div class="container_main_boy">
                <div class="col_small">
                    <div>
                        ...
                        <a href="{{ route('get.products', ['type' => 'boy']) }}" class="btn_1 mx-auto" target="_blank">All Boys Products<img loading="lazy" src="{{ asset('public/front/img/Home/blue-arr.svg') }}" alt="" height="10" width="10"></a>
                    </div>
                    ...
                    <div class="product_grid">
                        ...
                        <div class="product_wrapper">
                            <div class="product_card">
                                <div class="Product_item">
                                    <div class="swiper prod_img_slider">
                                    @if(isset($productImages) && is_countable($productImages) && count($productImages) > 0) 
                                        <div class="swiper-wrapper">
                                            @foreach($productImages as $k => $v)
                                            <div class="swiper-slide">
                                                <a href="{{ url('products-details/' . $val['url'].'/'. $val['id'])}}" target="_blank"><img loading="lazy" src="{{ asset('public/product_images/' . $v->product_image) }}" alt="{{ $val->name }}" class="img-fluid product_img w-100"></a>
                                            </div>
                                            @endforeach
                                        </div>
                                    @else
                                ...
                                <div>
                                    <a href="{{ url('products-details/' . $val['url'].'/'. $val['id'])}}" target="_blank"><h3 class="home_product_card_name">{{$val->name ?? ''}}</h3></a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        @else
                            <div class="d-flex justify-content-center align-items-center text-center" style="min-height: 100vh;">
                                <div><img loading="lazy" src="{{ asset('public/front/img/product-not-found.png') }}" alt="not found"></div>
                            </div>
                        @endif
                        {{-- <div class="product_wrapper">
                            <div class="product_card">
                                <div class="Product_item">
                                    <div class="swiper prod_img_slider">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <img loading="lazy" src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Shirt-Shorts-Co-ord-set-2-5Y-1.png"
                                                    alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                            </div>
                                            <div class="swiper-slide">
                                                <img loading="lazy" src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Cl-Shirt-short-2-5Y-1.png"
                                                    alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                            </div>
                                            <div class="swiper-slide">
                                                <img loading="lazy" src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Ca-Tshirts-short-2-5Y-1.png"
                                                    alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <h3 class="home_product_card_name">Frock 2pc Sets</h3>
                                </div>
                            </div>
                        </div>
                        <div class="product_wrapper">
            ...
            <div class="container_main_girl">
                ...
                <div class="col_small">
                    <div>
                        ...
                        <a href="{{ route('get.products', ['type' => 'girl']) }}" class="btn_1 mx-auto" target="_blank">All Girls Products<img loading="lazy" src="{{ asset('public/front/img/Home/blue-arr.svg') }}" alt="" height="10" width="10"></a>
                    </div>
                    <div class="hero_img_wrapper">
    ...
    <section class="home_mt-100">
            <div class="ym-container">
                ...
                <p class="text-center">Everything to build a children's department that sells — ages 0–14Y, from one
                    trusted source.</p>
                <div class="hero_why_wrapper">
                    <div class="d-flex align-items-center">
                        <img loading="lazy" src="{{ asset('public/front/img/Home/hero-why.png') }}" alt="img-fluid" class="img-fluid">
                        <div class="hero_why_content">
                            <div class="swiper why_slider">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    {{-- <div class="swiper-slide">
                                        <div class="why_slide">
                                            <h3 class="title_60lora">Own Manufacturing</h3>
                                            <p>Full control from fabric to finished garment — quality built into every
                                                stage. Private labeling and custom design available for partners ready
                                                to grow their own brand.</p>
                                        </div>
                                    </div> --}}
                                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        ...
                        <picture>
                            ...
                            <img loading="lazy" src="{{ asset('public/front/img/map-Frame.png') }}" alt="Global Map" class="img-fluid" loading="lazy">
                        </picture>
                    </div>
                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="flg_itemlist">
                                        @foreach ($globalpresence->where('cat_title', 'Africa') as $item)
                                            <div class="flg_item">
                                                <img loading="lazy" src="{{ asset('public/GlobalPresence_Logo_Image/' . $item->logo_image) }}" alt="{{ $item->logo_name }}" class="img-fluid">
