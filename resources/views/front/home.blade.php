                ...
                <div class="swiper swiper-row-2">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="image-card">
                                <img loading="lazy"
                                    src="https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=400&h=600&fit=crop"
                                    alt="Person 8">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="image-card">
                                <img loading="lazy"
                                    src="https://images.unsplash.com/photo-1504593811423-6dd665756598?w=400&h=600&fit=crop"
                                    alt="Person 9">
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="image-card">
                                <img loading="lazy"
                                    src="https://images.unsplash.com/photo-1552058544-f2b08422138a?w=400&h=600&fit=crop"
                                    alt="Person 12">
                            </div>
                        </div>
                        <div class="swiper-slide">
                ...
                <div class="swiper swiper-row-3">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="image-card">
                                <img loading="lazy"
                                    src="https://images.unsplash.com/photo-1557862921-37829c790f19?w=400&h=600&fit=crop"
                                    alt="Person 16">
                            </div>
                        </div>
                        <div class="swiper-slide">
        ...
        <div class="hero_overlay">
            <div class="hero_overlay_ctnt">
                ...
                <div class="btn_wrapper">
                    ...
                    <a href="" class="btn_1">Become a Distributor <img loading="lazy"
                            src="{{ asset('public/front/img/Home/blue-arr.svg') }}" alt="" height="10" width="10"></a>
                </div>
            </div>
        </div>
                            ...
                            <div class="Product_item">
                                <div class="swiper prod_img_slider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img loading="lazy"
                                                src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Shirt-Shorts-Co-ord-set-2-5Y-1.png"
                                                alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                        </div>
                                        <div class="swiper-slide">
                                            <img loading="lazy"
                                                src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Cl-Shirt-short-2-5Y-1.png"
                                                alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                        </div>
                                        <div class="swiper-slide">
                                            <img loading="lazy"
                                                src="https://www.intelliworkz.co.in/marhabafashion_laravel/public/product_images/Ca-Tshirts-short-2-5Y-1.png"
                                                alt="Frock 2pc Sets" class="img-fluid product_img w-100">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="product_wrapper">
                                <div class="product_card">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <a href="{{ url('products-details/' . $val['url'] . '/' . $val['id'])}}"
                                                                target="_blank"><img loading="lazy"
                                                                    src="{{ asset('public/product_images/' . $v->product_image) }}"
                                                                    alt="{{ $val->name }}" class="img-fluid product_img w-100"></a>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @else
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        <img loading="lazy"
                                                            src="{{ asset('public/front/img/product-not-found.png') }}"
                                    ...
                                    <div>
                                        <a href="{{ url('products-details/' . $val['url'] . '/' . $val['id'])}}"
                                            target="_blank">
                                            <h3 class="home_product_card_name">{{$val->name ?? ''}}</h3>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="ym-project">
                        ...
                        <div class="btn_wrapper">
                            <a href="{{ route('get.products', ['type' => 'boy', 'size_range' => 'junior']) }}"
                                class="btn_1" target="_blank">Explore Boy <img loading="lazy"
                                    src="./images/Home/blue-arr.svg" alt="" height="10" width="10"></a>
                ...
                <div class="hero_catologue_head col-lg-6">
                    ...
                    <div class="btn_wrapper">
                        ...
                        <a href="https://www.instagram.com/marhabafashionuae?igsh=cTluY2lzYTRpM2pp" class="btn_1"><img
                                ...
                                height="16" width="16"> Follow us on Instagram</a>
                    </div>
                </div>
            </div>
