<!-- Modal -->
<div class="modal fade" id="enquirybannerform"  tabindex="-1" aria-labelledby="enquirybannerformLabel" aria-hidden="true">
        ...
        <form id="enquireForm" > 
           <div class="row g-md-4">
                    ...
                    <div class="col-md-6">
                        <div class="form_floating_contect">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="category" placeholder="Company Name">
